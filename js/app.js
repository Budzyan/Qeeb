(() => {
    ...
    function initSliders() {
        if (document.querySelector(".categories-slider__slider")) {
            new core(".categories-slider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
                ...
                loop: true,
                navigation: {
                    prevEl: ".categories-slider__arrow.swiper-button-prev",
                    nextEl: ".categories-slider__arrow.swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.3,
            ...
            new core(".tranding-page__slider", {
                ...
                navigation: {
                    prevEl: ".tranding-page__button-prev",
                    nextEl: ".tranding-page__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
